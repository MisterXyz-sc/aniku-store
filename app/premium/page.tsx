        ...
        <div className="ticket overflow-hidden">
          ...
          {invoice.qr && (
            <button
              ...
              className="flex items-center justify-center gap-1.5 rounded-full border border-ink-line text-paper font-semibold py-2.5 text-xs mt-4 transition hover:border-gold/60 hover:text-gold"
            >
